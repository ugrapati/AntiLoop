      ...
      public static VARIANT FromObject(object var)
      {
        ...
        else if(!Convert.IsDBNull(var))
        {
          ...
          else
          {
            ...
            {
              throw new ArgumentException(SR.GetString("ConnPointUnhandledType",type.Name));
            }
      ...
      public object ToObject()
      {
        ...
        switch(num)
        {
          ...
          case 17:
            ...
            return (byte)(0xFFu&(byte)(int)intPtr);
          case 2:
            if(Byref)
            {
          ...
          case 18:
            ...
            return (ushort)(0xFFFFu&(ushort)(int)intPtr);
          case 3:
          case 22:
            if(Byref)
            {
          ...
          default:
            ...
            switch(num)
            {
              ...
              case 29:
                throw new ArgumentException(SR.GetString("COM2UnhandledVT","VT_USERDEFINED"));
              default:
              {
                int num2 = vt;
                throw new ArgumentException(SR.GetString("COM2UnhandledVT",num2.ToString(CultureInfo.InvariantCulture)));
              }
            }
        }
      }
